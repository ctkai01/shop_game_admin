@extends('layouts.app')
@section('title_for_layout', 'Edit Product')
@section('css')
...
@endsection
@section('bread')
{{ Breadcrumbs::render('edit_product', $id)}}
@endsection
@section('content')
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form data-id="{{ $id }}" data="{{ $categoriesCurrent }}" method="POST" id="form_edit" enctype="multipart/form-data" action="{{ route('products.update', $id) }}">
                    @csrf
                    <div class="col-lg-8 field-input" style="padding-left: 0px">
                        <div class="form-group" style="text-align: left">
                            ...
                            placeholder="Name"
                            value="{{ ($productEdit) ? $productEdit->name : old('name') }}">
                            @if ($errors->has('name'))
                    ...
                    <div class="col-lg-8 field-input" style="padding-left: 0px">
                        ...
                        <div class="mt-3 mb-3 preview-img preview-image" style="width: 150px;">
                            @if ($productEdit)
                                <img id="ImgPreview" src="{{ asset('storage/products/' . $productEdit->image) }}"
                                width="100%" />
                            @else
                    ...
                    <div class="col-lg-8 field-input" style="padding-left: 0px">
                        <div class="form-group" style="text-align: left">
                            ...
                            placeholder="Slug"
                            value="{{ ($productEdit) ? $productEdit->slug : old('slug') }}">
                            @if ($errors->has('slug'))
                    ...
                    <div class="col-lg-8 field-input" style="padding-left: 0px">
                        <div class="form-group" style="text-align: left">
                            ...
                            <input type="text" class="form-control" value="{{ ($productEdit) ? $productEdit->price : old('price') }}" id="price" name="price" placeholder="Price" value="">
                            @if ($errors->has('price'))
                    ...
                    <div class="col-lg-8 field-input" style="padding-left: 0px">
                        <div class="form-group" style="text-align: left">
                            ...
                            <input type="text" class="form-control" value="{{ ($productEdit) ? $productEdit->discount : old('discount') }}" id="discount" name="discount" placeholder="Discount" value="">
                    ...
                    <div class="col-lg-8 field-input" style="padding-left: 0px">
                        <div class="form-group" style="text-align: left">
                            ...
                            <input type="text" class="form-control" value="{{ ($productEdit) ? $productEdit->count : old('count') }}" id="count" name="count" placeholder="Count" value="">
                            @if ($errors->has('count'))
                    ...
                    <div class="col-lg-8 field-input" style="padding-left: 0px">
                        <div class="form-group" style="text-align: left">
                            ...
                            <textarea name="description" id="description">
                                {{ ($productEdit) ? $productEdit->description : old('description') }}
                            </textarea>
                        </div>
...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
    <script>
        ...
        $(document).ready(function (){
            ...
            categories = $('#form_edit').attr('data')
            ...
            categories.forEach(category => {
                ...
                //     category.id
                // )
                var newOption = new Option(category.name.trim(), category.id, true, true);
                $('.js-example-basic-multiple').append(newOption).trigger('change');

            });
            console.log(nameCategories)
            // var newOption = new Option(nameCategories, idCategories, false, false);
            // $('.js-example-basic-multiple').append(newOption).trigger('change');
            // $('.js-example-basic-multiple').val(nameCategories).select2();
