@extends('layouts.app')
@section('title_for_layout', 'Edit Detail Product')
@section('css')
...
@endsection
@section('bread')
{{ Breadcrumbs::render('edit_product-detail', $id)}}
@endsection
@section('content')
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h3 class="card-title">Edit Detail Product</h3>
                <form data-id="{{ $id }}" method="POST" id="form_edit" enctype="multipart/form-data" action="{{ route('detail-products.update', $id) }}">
                    @csrf
                    <div class="col-lg-8 field-input" style="padding-left: 0px">
                        <div class="form-group" style="text-align: left">
                            ...
                            placeholder="Name"
                            value="{{ ($nameProduct) ? $nameProduct : old('name') }}">
                            @if ($errors->has('name'))
                    ...
                    <div class="col-lg-8 field-input" style="padding-left: 0px">
                        <div class="form-group" style="text-align: left">
                            ...
                            value="{{ $detailProductEdit ? $detailProductEdit->code_card : old('code_card') }}">
                    ...
                    <div class="col-lg-8 field-input" style="padding-left: 0px">
                        <div class="form-group" style="text-align: left">
                            ...
                            value="{{ $detailProductEdit ? $detailProductEdit->game_account : old('game_account') }}">
                    ...
                    <div class="col-lg-8 field-input" style="padding-left: 0px">
                        <div class="form-group" style="text-align: left">
                            ...
                            value="{{ $detailProductEdit ? $detailProductEdit->password_account : old('password_account') }}">
