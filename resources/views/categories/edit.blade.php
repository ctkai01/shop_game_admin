@extends('layouts.app')
@section('title_for_layout', 'Edit Category')
@section('css')
...
@endsection
@section('bread')
{{ Breadcrumbs::render('edit_category', $id)}}
@endsection
@section('content')
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" id="form_interest" enctype="multipart/form-data" action="{{ route('categories.update', $id) }}">
                    @csrf
