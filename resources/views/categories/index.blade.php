@extends('layouts.app')
@section('title_for_layout', 'Categories Management')
@section('css')
        ...
        <div style="width: 100%" class="card">
            <div class="card-body">
                ...
                <div class="row mb-2 tool-search">
                    ...
                    <div class="col-md-5 text-right" style="height: 40px">
                        <div class="btn-group" style="height: 40px">
                            <a class="btn btn-success" id="btn_add_menu" href="{{ route('categories.create') }}">
                ...
                <div class="table-responsive custom-table">
                    <table id="datatableCategory" class="table table-striped table-bordered display" style="width:100%">
                        <thead>
                            <tr>
                                <th width="6%">No</th>
